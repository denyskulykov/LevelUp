...
class InvalidSitemap(AbstractSitemap):
    ...
    def __repr__(self):
        return ("{self.__class__.__name__}(" "url={self.url}, " "reason={self.reason}" ")").format(self=self)
...
class AbstractPagesSitemap(AbstractSitemap, metaclass=abc.ABCMeta):
    ...
    def __repr__(self):
        return ("{self.__class__.__name__}(" "url={self.url}, " "pages={self.pages}" ")").format(self=self)
    ...
    def all_pages(self) -> Iterator[SitemapPage]:
        ...
        for page in self.pages:
            yield page, self._AbstractSitemap__url
...
class AbstractIndexSitemap(AbstractSitemap):
    ...
    def __repr__(self):
        return ("{self.__class__.__name__}(" "url={self.url}, " "sub_sitemaps={self.sub_sitemaps}" ")").format(
            self=self
        )
